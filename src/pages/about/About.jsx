...
const About = () => {
  return (
    <>
      <section className="md-min:py-10 md-min:pt-20 pt-5">
        <div className="w-full items-center justify-center text-center pb-3 md-min:pb-1">
        <h1 className="text-[#33FFA8] font-extrabold uppercase tracking-wide md-min:text-6xl text-4xl pb-6">
            About
        </h1>
          <h1 className="text-2xl md-min:text-4xl font-bold text-center text-gray-800 md-min:leading-[40px] max-w-3xl mx-auto lg-min:px-28">
