...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="privacy-policy-container py-20 mb-20 px-20 md:px-16 lg:px-24">
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Our Privacy Policy</h1>
