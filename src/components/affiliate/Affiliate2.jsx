      ...
      <section>
        <div className="lg-min:flex px-6 md-min:px-12 lg-min:px-28 pb-10 pt-16">
          <div className="flex-1 flex-col py-10 space-y-5">
            ...
            <p className="md-min:r-28 font-normal text-sm md-min:text-base text-[#4F4E55] lg-min:w-[450px] 3xl:w-[600px] 3xl:text-2xl">
             ...
             <div className="flex items-center justify-start">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#11F1F1] to-[#33FFA8] border-black border-[1px] hover:background text-black font-bold py-2 mt-2 px-2 md-min:px-4 rounded-[10px]"
                >
                  Become an Affiliate
                </button>
              </div>
