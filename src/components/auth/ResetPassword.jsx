...
function ResetPassword() {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || "An error occurred while resetting the password", { autoClose: 2000 });
    }
              ...
              <form className="flex flex-col gap-5 leading-10" onSubmit={handleResetPassword}>
                ...
                <div className="relative">
                  <input
                    ...
                    maxLength={8}
                    className="w-full outline-none text-grays border-b-2 border-grey mt-20 px-4"
                  />
                      <FontAwesomeIcon
                ...
                <div className="relative">
                  <input
                    ...
                    maxLength={8}
                    className="w-full outline-none text-grays border-b-2 border-grey mt-5 px-4"
                  />
                      <FontAwesomeIcon
